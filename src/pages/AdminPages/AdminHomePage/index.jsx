...
import AdminAnalyticsIntegrationMenu
    from "../../../components/AdminComponents/AdminMenus/AdminAnalyticsIntegrationMenu/index.jsx";
    ...
    return <section id="adminHomePage">
        ...
        <div className="wrapper">
            ...
            <div className="adminWrapper">
                ...
                {url.pathname === '/cp/analytics-integration' && <div className="container1">
                    <AdminAnalyticsIntegrationMenu/>
                </div>}
            </div>
        </div>
    </section>;
