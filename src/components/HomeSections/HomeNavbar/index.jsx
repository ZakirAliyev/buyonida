...
function HomeNavbar() {
  ...
  return <section id={'homeNavbar'}>
            <img src={image1} alt={'Logo'} onClick={() => navigate('/')} />
            <div className={'drawer'}>
                <HomeNavbarDrawer />
            </div>
            <ul>
                <ScrollLink smooth={true} duration={500} className={'link'} onClick={() => handleNavigation('/blogs')}>{t("blogs")}</ScrollLink>
                <ScrollLink smooth={true} duration={500} className={'link'} onClick={() => handleNavigation('/about')}>{t("about_us")}</ScrollLink>
                <ScrollLink smooth={true} duration={500} className={'link'} onClick={() => handleNavigation('/contact')}>{t("contact_us")}</ScrollLink>
                <span className={'link'} onClick={handlePricingClick} style={{
        cursor: 'pointer'
      }}>{t("pricing")}</span>
                ...
                {token ? <div className={'profileWrapper'}>
          ...
          cursor: 'pointer'
              ...
              textAlign: 'end'
                            ...
                            <div className={'profilePhoto'}>
                                <img src={USER_LOGO + user1?.profileImageName} alt={'Profile'} /> {/* Replace with actual profile image */}
                            </div>
                        </div>
                ...
                fontWeight: '400'
                            ...
                            <div className={'wrapper'}>
                                ...
                                <div className={'box'}>
                                    <span>{t("get_help")}</span>
                                </div>
                            </div>
                        </div>
                    </div> : <>
                        <Link to={'/login'} className={'link logInBtn'}>{t("log_in")}</Link>
                        <Link to={'/register'} className={'link signUpBtn'}>{t("sign_up")}</Link>
                    </>}
            </ul>
        </section>;
}
