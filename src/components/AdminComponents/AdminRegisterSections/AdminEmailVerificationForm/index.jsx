...
import { usePostConfirmEmailOwnerMutation, usePostCreateNewConfirmEmailCodeOwnerMutation } from "../../../../service/userApi.js";
...
function AdminEmailVerificationForm() {
  ...
  return <section id="adminEmailVerificationForm">
            <div className="wrapper">
                ...
                <div className="title">
                    ...
                    <h3>{localStorage.getItem('email')}{t("adresin_g_nd_ril_n_kodu_daxil_et_v_hesab_n_t_stiql")}</h3>
                </div>
          ...
          color: '#0866FF'
                        ...
                        <Countdown key={countdownKey} // Reset Countdown with key
          ...
          try {
            const response = await postConfirmEmailOwner({
              email,
              code
            }).unwrap();
