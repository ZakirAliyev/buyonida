...
function AdminAddProductMenu() {
    ...
    const isFormValid =
        ...
        compareAtPrice.trim() !== "" &&
        !isNaN(parseFloat(compareAtPrice)) &&
        images.length > 0 &&
        ...
        <section id="adminAddProductMenu">
            <div className="umumi">
                ...
                <AiOutlineExclamationCircle className="icon" />
                    ...
                    <div className="inputWrapper">
                        <label>Images</label>
                        <div className="uploaded-images" style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                            <label className="image-upload-container" style={{ position: "relative" }}>
                                <div className="image-upload-button zakir" style={{ aspectRatio: "1/1" }}>
                                    <FiPlus className="icon" />
                                </div>
                            ...
                            {images?.length > 0 &&
                                images.map((image, index) => (
                                    <div key={index} className="uploaded-image-wrapper" style={{ position: "relative" }}>
                ...
                <div className={"row"}>
                    <div className={"col-4"} style={{ padding: "0 8px 0 0", height: "283px" }}>
                        <div className={"wrapper"}>
                            <div className="inputWrapper">
                                <label>Price</label>
                                <input
                ...
                {errors.variant && (
                    <div className="error-text" style={{ color: "red", textAlign: "center", marginTop: "8px" }}>
                        {errors.variant}
                    </div>
                )}
                <button
            ...
            <Modal
                ...
                width={1000}
                modalRender={(modal) =>
                    React.cloneElement(modal, { style: { ...modal.props.style, padding: 0, borderRadius: "20px" } })
                }
            >
                <AdminSelectFile />
            </Modal>
