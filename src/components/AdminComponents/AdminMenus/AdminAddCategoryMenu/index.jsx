...
import { useGetAllProductsByMarketIdQuery, usePostCreateCategoryMutation } from "../../../../service/userApi.js";
...
function AdminAddCategoryMenu() {
  ...
  const handleDescriptionChange = value => {
    ...
    setErrors(prev => ({
      ...prev,
      description: value.replace(/<(.|\n)*?>/g, "").trim() === "" ? "Description can't be blank" : ""
    }));
  };
  ...
  const handleSaveChanges = async e => {
    ...
    if (description.replace(/<(.|\n)*?>/g, "").trim() === "") newErrors.description = "Description can't be blank";
  ...
  return <section id="adminAddCategoryMenu">
            <div className="umumi">
                {/* Üstteki status bar */}
                <div className="abso">
            ...
            paddingRight: "8px"
                            ...
                            <div className="wrapper">
                                ...
                                <div className="inputWrapper">
                                    <label>{t("title")}</label>
                                    <input type="text" id="categoryTitle" name="title" placeholder="Enter category title" value={title} onChange={handleTitleChange} className={errors.title ? "errorInput" : ""} />
              ...
              padding: 0
                ...
                padding: "16px 32px 0 32px"
                  ...
                  position: "relative"
                                            ...
                                            <img src={URL.createObjectURL(file)} alt="Uploaded preview" style={{
                    maxWidth: "100%",
                    maxHeight: 300
                  }} className="image111" />
                  ...
                  borderWidth: "2px"
                                    ...
                                    {errors.file && <span className="error-text" style={{
                  marginLeft: "16px",
                  marginTop: 32
                }}>
                      <AiOutlineExclamationCircle className="icon" />
          ...
          color: "white"
                        ...
                        <button type="submit">
                            {addLoading ? <PulseLoader color={"white"} /> : <>{t("save_changes")}</>}
                        </button>
                    </div>
                </form>
            </div>
